...
- [`javascript-and-jquery/`](javascript-and-jquery/README.md) — *JavaScript & jQuery: Interactive Front-End Web Development* (Jon Duckett): concept notes (programming basics, DOM, events, jQuery, Ajax/JSON, APIs, debugging, content panels, filtering/sorting, form validation); no stage projects yet.
